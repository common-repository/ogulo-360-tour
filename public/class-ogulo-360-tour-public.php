 ...
 * @subpackage Ogulo_360_Tour/public
 */
...
class Ogulo_360_Tour_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/ogulo-360-tour-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/ogulo-360-tour-public.js', array( 'jquery' ), $this->version, false );
